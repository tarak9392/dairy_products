...
export const defaultDishes: CarouselItem[] = [
  {
    tag: "#OrganicFarm",
    titleLine1: "FARM FRESH MILK",
    titleLine2: "– FULL CREAM COW MILK",
    desc: "100% pure pasteurized unadulterated whole milk delivered fresh by 7 AM daily",
    img: "https://images.unsplash.com/photo-1550583724-b2692b85b150?w=800&auto=format&fit=crop&q=80",
    ctaText: "Order Fresh",
    ctaUrl: "/products",
  },
  {
    tag: "#Traditional",
    titleLine1: "PURE DESI GHEE",
    titleLine2: "– BILONA CHURNED",
    desc: "Aromatic golden ghee crafted using traditional earthen pot churned butter",
  ...
  {
    tag: "#Probiotic",
    titleLine1: "ORGANIC FARM CURD",
    titleLine2: "– THICK CULTURED DAHI",
    desc: "Traditional thick creamy curd made from natural whole cow milk cultures",
  ...
  {
    tag: "#Artisanal",
    titleLine1: "FRESH MALAI PANEER",
    titleLine2: "– SOFT COTTAGE CHEESE",
    desc: "Velvety soft fresh paneer blocks handmade from organic whole cow milk",
    img: "https://images.unsplash.com/photo-1631452180539-96aca7d48617?w=800&auto=format&fit=crop&q=80",
    ctaText: "Order Fresh",
    ctaUrl: "/products",
  },
  {
    tag: "#FarmBakery",
    titleLine1: "SALTED FARM BUTTER",
    titleLine2: "– SLOW CHURNED BATCH",
    desc: "Rich churned butter with a hint of sea salt for your morning breakfast toast",
    img: "https://images.unsplash.com/photo-1589985270826-4b7bb135bc9d?w=800&auto=format&fit=crop&q=80",
    ctaText: "Order Fresh",
    ctaUrl: "/products",
  },
];
